...
export function VendorSearchFilters({ categories }: { categories: Category[] }) {
    ...
    return (
        <div className="flex flex-col md:flex-row gap-4 mb-8 bg-white p-6 rounded-2xl border-2 border-slate-900 shadow-[8px_8px_0px_0px_rgba(15,23,42,1)]">
            <div className="flex-1 relative">
                ...
                <Input
                    placeholder="Search by name, person or business..."
            ...
            <div className="flex-1 md:max-w-[250px] relative">
